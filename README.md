...
You can always add the React plugin to an existing workspace by installing `@lighth7015/preact` and then generating an React application, as follows: `nx g @lighth7015/preact:app myapp`.
